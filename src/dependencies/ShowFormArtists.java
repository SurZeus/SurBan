...
public class ShowFormArtists {
	
		private Connection connect=null;
		private Statement statement=null;
		private ResultSet resultSet=null;
		public static String[][] Artysci ;
	...
	public ShowFormArtists() {
		...
		public void displayMusic() throws Exception {
			try {
				...
				ResultSet rs;
				rs=stmt.executeQuery("SELECT COUNT(nazwa_wykonawcy) FROM wykonawca");
			...
			Artysci = new String[count][1];
			 resultSet=statement.executeQuery("SELECT  nazwa_wykonawcy  FROM wykonawca");
			 writeResultSet(resultSet,count,Artysci);
				connect.close();
		...
		public void writeResultSet(ResultSet resultSet,int ct,String[][] tb) throws SQLException
		{
			...
			while (resultSet.next()) {
				tb[i][0]=resultSet.getString("nazwa_wykonawcy");
